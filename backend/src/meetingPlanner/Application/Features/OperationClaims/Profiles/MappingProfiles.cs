...
public class MappingProfiles : Profile
{
    public MappingProfiles()
    {
        ...
        CreateMap<OperationClaim, GetListOperationClaimForSelectionListItemDto>().ReverseMap();
        CreateMap<IPaginate<OperationClaim>, GetListResponse<GetListOperationClaimForSelectionListItemDto>>().ReverseMap();
    }
}
