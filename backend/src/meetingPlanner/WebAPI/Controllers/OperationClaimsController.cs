...
using Application.Features.OperationClaims.Queries.GetListForSelection;
...
public class OperationClaimsController : BaseController
{
    ...
    public async Task<IActionResult> GetListForSelection([FromQuery] PageRequest pageRequest)
    {
        GetListOperationClaimForSelectionQuery getListOperationClaimForSelectionQuery = new() { PageRequest = pageRequest };
        GetListResponse<GetListOperationClaimForSelectionListItemDto> result = await Mediator.Send(getListOperationClaimForSelectionQuery);
        return Ok(result);
    }
